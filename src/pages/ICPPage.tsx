...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Screening or interviewing at volume', icon: '🔍', segments: ['hr'] },
      { label: 'Training completion & retention', icon: '📈', segments: ['ld', 'hr'] },
      { label: 'Client intake & discovery', icon: '💼', segments: ['cs', 'agency'] },
      { label: 'Attestation & compliance records', icon: '✅', segments: ['compliance', 'ops'] },
      { label: 'Following up on anything, at scale', icon: '📬', segments: ['ops', 'hr', 'cs', 'ld', 'agency', 'compliance'] },
    ],
  },
  {
    id: 'scale',
    ...
    options: [
      { label: '1–20 people', icon: '👤', segments: ['agency', 'cs'] },
      { label: '20–100 people', icon: '👥', segments: ['ops', 'cs', 'compliance', 'hr'] },
